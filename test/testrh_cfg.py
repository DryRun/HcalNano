...
process.load("HCALPFG.HcalNano.hcalrechittable_cff") # loads all modules
...
#-----------------------------------------------------------------------------------
#process.hcalDigiTask = cms.Task(hcalDigis)
#process.hcalDigiSequence = cms.Sequence()

process.hcalRecHitTask = cms.Task(
    #process.L1Reco,
...
#proccess.hcalRecHitSequence = cms.Sequence(process.hcalRecHitTask)
